    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-lg font-medium text-gray-500 mt-1">From Architecture Blindness to Architectural Fluency.</p>
          <p className="text-sm text-gray-400 mt-0.5">The Intelligence Platform for Better Decisions.</p>
        </div>
